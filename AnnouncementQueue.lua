...
GuildWeave.AnnouncementQueue = {
	_queue = {},
	_playing = false,
}

function GuildWeave.AnnouncementQueue:Push(showFn)
...
function GuildWeave.AnnouncementQueue:_Next()
...
function GuildWeave.AnnouncementQueue:Finished()
	self._playing = false
	self:_Next()
end
