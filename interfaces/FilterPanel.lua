...
-- Shared filter panel factory used by panels that need a name/role/profession
-- filter flyout (e.g. GuildPanel, OfficerPanel tabs).

GuildWeave.Shared = GuildWeave.Shared or {}
...
function GuildWeave.Shared.CreateFilterPanel(cfg)
    ...
    if getDataFn then
        ...
        profList:SetBackdrop(GuildWeave.Constants.PANEL_BACKDROP)
        ...
        GuildWeave:RegisterOutsideClickClose(profList, fp)
    end
